...
combatStrength = get_integer_input("Enter your combat Strength: ")
mCombatStrength = get_integer_input("Enter the monster's combat Strength: ")
...
weaponRoll = random.choice(diceOptions) - 1  # Subtract 1 to match the array index
selectedWeapon = weapons[weaponRoll]
combatStrength += weaponRoll + 1  # Add weapon strength to combat strength

print(f"You rolled a {weaponRoll + 1} and got the weapon: {selectedWeapon}")
...
print("--- Phew, you have a healing potion: " + str(
    not (
        healthPoints < mCombatStrength  # monster will NOT kill hero in one blow
    )
    and
